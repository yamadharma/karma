...
# $Header: /var/cvsroot/gentoo-x86/media-video/gpac/gpac-0.4.5-r4.ebuild,v 1.3 2011/02/16 22:55:47 aballier Exp $
...
src_unpack() {
	...
	local OPENJPEG_VERSION="$(pkg-config --modversion libopenjpeg)"
	sed -i -e "/\"OpenJPEG \"/s:OPENJPEG_VERSION:\"${OPENJPEG_VERSION}\":" \
