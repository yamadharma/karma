...
# $Header: /var/cvsroot/gentoo-x86/net-misc/cfengine/cfengine-2.1.14.ebuild,v 1.1 2005/04/30 02:39:37 ramereth Exp $
...
src_install() {
	...
	fowners root:root /var/lib/cfengine/modules/module\:cfportage
	
	dosym /var/lib/cfengine /var/cfengine
	newinitd "${FILESDIR}"/cfengine.rc6 cfengine
}
