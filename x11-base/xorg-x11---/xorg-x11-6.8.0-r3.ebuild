...
cflag_setup() {
	...
	gcc -fno-stack-protector -S -o /dev/null -xc /dev/null >/dev/null 2>&1 && append-flags -fno-stack-protector
}
...
#		unpack ${P}.tar.bz2
	...
	echo "My patches apply"
#	epatch ${FILESDIR}/6.7.8-fix_xftint.h.patch
#	epatch ${FILESDIR}/give-xorg-some-ssp-lovin.patch
#	epatch ${FILESDIR}/xorg-x11-hardenedgcc2.patch
