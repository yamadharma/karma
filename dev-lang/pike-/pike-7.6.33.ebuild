...
IUSE="crypt debug doc fftw gdbm gif gtk gtk2 java jpeg mysql oci8 odbc opengl pdflib postgres scanner sdl tiff truetype zlib perl ffmpeg svg kerberos"
...
#	myconf="${myconf} --without-copt --without-dynamic-modules"
