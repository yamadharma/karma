...
SRC_URI="ftp://ftp.caudium.net/pike/7.2/unofficial/${P}.tar.gz"
...
# }}}
    ...
    if use java
	then
	export LD_LIBRARY_PATH=`java-config -O`/jre/lib/i386/native_threads:`java-config -O`/jre/lib/i386/server${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}
