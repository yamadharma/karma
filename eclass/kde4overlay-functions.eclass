...
# $Header: /var/cvsroot/gentoo-x86/eclass/kde4overlay-functions.eclass,v 1.4 2008/03/13 17:57:51 ingmar Exp $

# @ECLASS: kde4overlay-functions.eclass
# @MAINTAINER:
# kde@gentoo.org
...
kde-base/kdebase kde-base/raptormenu
...
kde-base/kdeutils kde-base/printer-applet
...
#
# Note that kde4overlay-base.eclass already does this.
buildsycoca() {
...
# translations ebuilds must call enable_selected_linguas(). kde4overlay-base.eclass does
# this for you.
#
...
# flags are missing
_kde4overlay-functions_built_with_use() {
...
# @FUNCTION: kde4overlay-functions_check_use
# @DESCRIPTION:
