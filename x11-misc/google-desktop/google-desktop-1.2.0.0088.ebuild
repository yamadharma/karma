...
SRC_URI="x86? ( http://dl.google.com/linux/rpm/stable/i386/google-desktop-linux-${PV}.i386.rpm )
	amd64? ( http://dl.google.com/linux/rpm/stable/x86_64/google-desktop-linux-${PV}.x86_64.rpm )"
...
pkg_nofetch() {
	einfo "Please download google-desktop-linux-current.rpm yourself from http://desktop.google.com/linux"
	einfo "rename it to "
	einfo "google-desktop-linux-${PV}.i386.rpm"
	einfo "or google-desktop-linux-${PV}.x86_64.rpm"
