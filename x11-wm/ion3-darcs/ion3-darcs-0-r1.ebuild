...
src_unpack() {
	...
	download-darcs-repo http://iki.fi/tuomov/repos/mod_ionflux-3 ion-3/mod_ionflux || die "mod_ionflux repo download failure"
	download-darcs-repo http://iki.fi/tuomov/repos/mod_xrandr-3 ion-3/mod_xrandr || die "mod_xrandr repo download failure"
	download-darcs-repo http://iki.fi/tuomov/repos/ion-scripts-3 ion-3/ion-scripts || die "ion-scripts repo download failure"
	
	download-darcs-repo http://iki.fi/tuomov/repos/ion-doc-3 ion-3/ion-doc || die "ion-doc repo download failure"
