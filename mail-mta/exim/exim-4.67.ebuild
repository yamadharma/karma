...
# $Header: /var/cvsroot/gentoo-x86/mail-mta/exim/exim-4.67.ebuild,v 1.6 2007/05/03 19:57:50 peitolm Exp $
...
SLOT="0"
LICENSE="GPL-2"
KEYWORDS="~ia64 ~ppc64 ~sparc x86 amd64"
...
src_unpack() {
	...
	if use domainkeys; then
		...
		LDFLAGS += -ldomainkeys -L/usr/lib/libdomainkeys" >> Local/Makefile
	fi
