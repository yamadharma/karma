...
# $Header: /home/cvsroot/gentoo-x86/sys-kernel/wolk-sources/wolk-sources-4.0_rc1.ebuild,v 1.1 2003/02/23 18:58:06 livewire Exp $
...
#    bzcat ${DISTDIR}/linux-${OKV}${EXTRAVERSION}.patch.bz2 | patch -p1
    ...
    # 
    bzcat ${DISTDIR}/linux-2.4.20-wolk4.0s-to-4.1s.patch.bz2 | patch -p1
    bzcat ${DISTDIR}/linux-2.4.20-wolk4.1s-to-4.2s.patch.bz2 | patch -p1
}
src_install() {
		 dodir /usr/src
