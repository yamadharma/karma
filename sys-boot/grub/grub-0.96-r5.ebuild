...
# $Header: /var/cvsroot/gentoo-x86/sys-boot/grub/grub-0.96-r3.ebuild,v 1.1 2005/08/03 03:09:44 vapier Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/grub-${PV}-diskless.patch
