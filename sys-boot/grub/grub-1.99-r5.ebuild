...
inherit mount-boot eutils flag-o-matic pax-utils toolchain-funcs ${LIVE_ECLASS} bzr
unset LIVE_ECLASS
...
IUSE="custom-cflags debug device-mapper efiemu nls static sdl truetype extras"
