...
# A simple version bump is not enough, you also need to update _archive_offset, which can be found (with a hex editor, for example) by the signature in the comment.
...
src_install() {
	...
	systemd_dounit ${S}/AmneziaVPN/AmneziaVPN.service
	doicon -s 512 ${S}/AmneziaVPN/AmneziaVPN.png
