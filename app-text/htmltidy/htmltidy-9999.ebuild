...
ECVS_AUTH="pserver"
ECVS_SERVER="tidy.cvs.sourceforge.net:/cvsroot/tidy"
ECVS_MODULE="tidy"
ECVS_BRANCH="HEAD"
ECVS_LOCALNAME="tidy"
WANT_AUTOMAKE=1.5
...
SRC_URI="http://tidy.sourceforge.net/docs/tidy_docs_051020.tgz
...
src_unpack() {
	...
	cd ${WORKDIR}	
	tar xzf ${DISTDIR}/tidy_docs_051020.tgz
	tar xzf ${DISTDIR}/html2db.tar.gz
	...
	epatch ${FILESDIR}/tidyrc.patch || die
