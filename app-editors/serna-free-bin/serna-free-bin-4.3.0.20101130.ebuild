...
SRC_URI="http://downloads.syntext.com/serna/serna-free-4.3.0-20101130-linux.tgz"
...
# From the outside it is 4.3.0 but if it comes to the installer it is just 4.3.  
  SERNA_NAME=serna-free
  SERNA_TGZ=${SERNA_NAME}-4.3.tgz
  SERNA_DIR=${SERNA_NAME}-4.3
  SERNA_SCRIPT=${SERNA_NAME}-4.3
