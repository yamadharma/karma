...
src_install () 
{
	...
	mkdir ${T}/emacs-${SLOT}
	mv ${S}/GNUstep/build/Emacs.app/Resources/info/dir ${T}
	for i in ${S}/GNUstep/build/Emacs.app/Resources/info/*
	    do
	...
	rm -rf ${S}/GNUstep/build/Emacs.app/Resources/info

	newenvd ${FILESDIR}/60emacs-${SLOT}.envd 60emacs-${SLOT}

	einfo "Fixing manpages..."
	dodir /usr/share/man/man1
	cd ${S}/GNUstep/build/Emacs.app/Resources/man/man1
	for m in * 
	    do
	    mv ${m} ${D}/usr/share/man/man1/${m/.1/.emacs-${SLOT}.1} || die "mv ${m} failed"
	done
	cd ${S}
	rm -rf ${S}/GNUstep/build/Emacs.app/Resources/man

	einfo "Add read permission..."
	chmod -R a+r ${S}/GNUstep/build/Emacs.app
	
	dodir ${GNUSTEP_SYSTEM_ROOT}/Applications
	mv ${S}/GNUstep/build/Emacs.app ${D}/${GNUSTEP_SYSTEM_ROOT}/Applications
