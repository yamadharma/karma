...
inherit flag-o-matic eutils alternatives toolchain-funcs gnustep versionator


MY_PV=23.0.0_NS-$(get_version_component_range -2 "${PV}" )pre$(get_version_component_range 4- "${PV}" ) 

DESCRIPTION="A Cocoa port of Emacs for MacOS X and GNUstep"
HOMEPAGE="http://emacs-app.sourceforge.net"
SRC_URI="mirror://sourceforge/emacs-app/emacs-${MY_PV}.tar.bz2"

S=${WORKDIR}/emacs-${MY_PV}
