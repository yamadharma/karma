...
# $Header: /var/cvsroot/gentoo-x86/mail-filter/spamassassin/spamassassin-3.3.1-r4.ebuild,v 1.4 2010/12/05 16:46:37 armin76 Exp $
...
PATCHES=( "${FILESDIR}/${P}-PERL-5-12.patch"
	"${FILESDIR}"/${P}-uninitialized_value.patch )
