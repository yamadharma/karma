...
# $Header: /var/cvsroot/gentoo-x86/www-client/kazehakase/kazehakase-0.3.5.ebuild,v 1.1 2006/02/08 21:03:09 nakano Exp $

IUSE="migemo estraier thumbnail firefox ssl ruby"

DESCRIPTION="a browser with gecko engine like Epiphany or Galeon."
SRC_URI="mirror://sourceforge.jp/${PN}/18847/${P}.tar.gz"
...
DEPEND="!firefox? ( >=www-client/mozilla-1.7 )
	...
	ruby? ( dev-lang/ruby dev-ruby/ruby-gettext )"
