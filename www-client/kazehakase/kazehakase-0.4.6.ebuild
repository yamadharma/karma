...
# $Header: /var/cvsroot/gentoo-x86/www-client/kazehakase/kazehakase-0.4.6.ebuild,v 1.1 2007/04/29 08:03:44 matsuu Exp $

IUSE="hyperestraier migemo ruby ssl"

DESCRIPTION="a browser with gecko engine like Epiphany or Galeon."
SRC_URI="mirror://sourceforge.jp/${PN}/25149/${P}.tar.gz"
