...
SRC_URI="mirror://sourceforge/otcl-tclcl/${PN}-src-${PV}.tar.gz"
...
src_unpack() {
	...
	EPATCH_OPTS="-p1 -d${S}" epatch ${FILESDIR}/${P}-badfreefix.patch
	EPATCH_OPTS="-p1 -d${S}" epatch ${FILESDIR}/${P}-configure-cleanup.patch
