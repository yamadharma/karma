...
# $Header: /var/cvsroot/gentoo-x86/app-emacs/bbdb/bbdb-2.35_pre20040323.ebuild,v 1.6 2004/06/24 22:06:34 agriffis Exp $
...
src_install() {
	...
	use ecf || elisp-site-file-install ${FILESDIR}/50bbdb-gentoo.el || die
