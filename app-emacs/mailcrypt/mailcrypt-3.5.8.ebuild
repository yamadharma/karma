...
# $Header: /var/cvsroot/gentoo-x86/app-emacs/mailcrypt/mailcrypt-3.5.8.ebuild,v 1.6 2004/06/24 22:17:39 agriffis Exp $
...
src_install() {
	...
	use ecf || elisp-site-file-install ${FILESDIR}/50mailcrypt-gentoo.el
