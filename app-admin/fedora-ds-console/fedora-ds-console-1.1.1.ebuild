...
DESCRIPTION="A Java based remote management console used for Managing Fedora Administration Server and Fedora Directory Server."
...
src_unpack() {
	unpack ${A}
	cd ${S}
	epatch ${FILESDIR}/${P}-add_missing_files-1.patch
...
src_install() {
	java-pkg_jarinto /usr/share/dirsrv/java
