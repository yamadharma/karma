...
# $Header: /home/cvsroot/gentoo-x86/app-admin/systemimager-common-bin/systemimager-common-bin-3.0.1.ebuild,v 1.3 2003/11/06 00:01:53 mr_bones_ Exp $
...
# Commented out temporarily to fix repoman output
# RDEPEND="${DEPEND}
