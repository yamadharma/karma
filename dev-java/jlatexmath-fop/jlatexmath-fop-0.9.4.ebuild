...
SRC_URI="http://forge.scilab.org/index.php/p/jlatexmath/downloads/186/get/ -> jlatexmath-src-all-${PV}.zip"
...
S="${WORKDIR}"/jlatexmath-${PV}/plugin/fop

src_prepare() {
	cd "${WORKDIR}"/jlatexmath-${PV}
