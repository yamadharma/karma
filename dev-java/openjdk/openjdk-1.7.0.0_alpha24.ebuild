...
src_unpack() {
	...
	PATCHES="external-zlib-b18 external-zlib-splash-b17 external-jpeg-splash-b17 \
		external-giflib-b17 external-libpng-b17 gettimeofday-declaration j2se-cxxflags \
		hotspot-cflags cpuid-fomit-frame-pointer icedtea-text-relocations \
		execstack external-libXinerama-b17 tempname-free \
		fontconfig-directlink"
