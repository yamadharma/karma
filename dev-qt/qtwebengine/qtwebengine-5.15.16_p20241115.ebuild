...
PATCHES=(
	"${WORKDIR}/${PATCHSET}"
	${FILESDIR}/0001-third_party-crashpad-Fix-noexcept-and-throw-missing.patch
	${FILESDIR}/0002-third_party-perfetto-Adds-a-missing-noexcept-specifi.patch
	${FILESDIR}/0003-3rdparty-chromium-Fix-deprecated-__has_trivial_xxx-i.patch
