...
DEPEND="
    ...
    postgres?	( >=virtual/postgresql-libs-8.2 )
...
src_unpack() {
    ...
    epatch "${FILESDIR}/${P}-gcc-libffi-path.patch"
    epatch "${FILESDIR}/${P}-sdl.patch"
    epatch "${FILESDIR}/${P}-help-path.patch"
    epatch "${FILESDIR}/${P}-mimetype-registration.patch"
