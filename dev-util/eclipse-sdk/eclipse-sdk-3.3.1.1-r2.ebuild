...
CDEPEND="=dev-java/ant-eclipse-ecj-3.3*
	...
	=dev-java/junit-4*
	=dev-java/swt-${PV}*
	|| ( =dev-java/jsch-0.1.37* =dev-java/jsch-0.1.36* =dev-java/jsch-0.1.34* )
	=dev-java/icu4j-3.6*
...
src_compile() {
	...
	local system_jars="$(java-pkg_getjars swt-3,icu4j,ant-core,jsch,ant-nodeps,junit-4,tomcat-servlet-api-2.4,lucene-1.9):$(java-pkg_getjars --build-only sun-j2me-bin)"
