...
SRC_URI="CiscoPacketTracer_${PV//./}_Ubuntu.deb"
# SRC_URI="CiscoPacketTracer900_Open_Beta_July_Build680_linux_amd64_Exp20251231.deb"
...
SLOT="0"
KEYWORDS="~amd64"
RESTRICT="fetch mirror strip binchecks"
...
src_prepare() {
	mv ${S}/opt/pt/packettracer.AppImage ${S}
	7z x ${S}/packettracer.AppImage
...
src_install(){
	...
	newbin "${FILESDIR}/${PN}-9.0" "${PN}"

	## Hack
	cp ${S}/usr/lib/* ${ED}/opt/pt/bin
}
