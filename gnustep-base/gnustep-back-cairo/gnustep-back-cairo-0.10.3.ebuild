...
src_unpack() {
	...
	sed -i -e "s:BitstreamVeraSans-Roman:DejaVuSans:g" \
	    ...
	    ${S}/Source/cairo/CairoFontEnumerator.m
	    
	echo "ADDITIONAL_INCLUDE_DIRS += `freetype-config --cflags`" >> ${S}/Source/cairo/GNUmakefile.preamble
}
...
src_install() {
	...
	dosym $(egnustep_system_root)/Library/Bundles/libgnustep-cairo-010.bundle $(egnustep_system_root)/Library/Bundles/libgnustep-cairo.bundle 
}
