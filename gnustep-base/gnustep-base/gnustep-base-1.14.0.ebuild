...
src_install() {
	...
	if use doc;
	then
		local make_eval="-j1 LD_LIBRARY_PATH=\"\${D}\${base_temp_lib_path}:\${LD_LIBRARY_PATH}\""
...
pkg_postinst() {
	...
	ewarn "Run:"
	ewarn "revdep-rebuild --library \"libgnustep-base.so.1.1[0123]\""
}
