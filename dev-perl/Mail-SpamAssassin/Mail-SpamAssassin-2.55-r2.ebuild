...
myconf="${myconf} SYSCONFDIR=${D}/etc INST_PREFIX=/usr INST_SYSCONFDIR=/etc RUN_RAZOR1_TESTS=n RUN_RAZOR2_TESTS=n"
mymake="PREFIX=/usr SYSCONFDIR=/etc"
mydoc="License TODO Changes procmailrc.example sample-nonspam.txt sample-spam.txt INSTALL* BUGS CONTRIB* COPYRIGHT USAGE"
