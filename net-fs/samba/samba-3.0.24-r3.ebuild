...
# $Header: /var/cvsroot/gentoo-x86/net-fs/samba/samba-3.0.24-r3.ebuild,v 1.9 2007/06/24 22:07:15 vapier Exp $
...
src_compile() {
	...
	use afs && myconf="${myconf} --with-fake-kaserver --with-vfs-afsacl" #--with-afs 
