...
# $Header: /var/cvsroot/gentoo-x86/net-fs/openafs-kernel/openafs-kernel-1.4.4.ebuild,v 1.7 2007/06/02 11:54:00 armin76 Exp $
...
#	EPATCH_SUFFIX="patch" epatch ${FILESDIR}/1.4
	epatch ${FILESDIR}/${MY_P}-2.6.22.patch
...
src_install() {
	...
	#
	mv ${MOD_SRCDIR}/openafs.${KV_OBJ} ${MOD_SRCDIR}/libafs.${KV_OBJ}
	#
