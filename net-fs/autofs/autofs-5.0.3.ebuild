...
src_install() {
	...
	insopts -m 755
	doexe modules/*.so
	dosym /usr/$(get_libdir)/autofs/lookup_file.so /usr/$(get_libdir)/autofs/lookup_files.so
	dosym /usr/$(get_libdir)/autofs/lookup_yp.so /usr/$(get_libdir)/autofs/lookup_nis.so
	dosym /usr/$(get_libdir)/autofs/lookup_ldap.so /usr/$(get_libdir)/autofs/lookup_ldaps.so
	dosym /usr/$(get_libdir)/autofs/mount_nfs.so /usr/$(get_libdir)/autofs/mount_nfs4.so
	dosym /usr/$(get_libdir)/autofs/mount_ext2.so /usr/$(get_libdir)/autofs/mount_ext3.so
