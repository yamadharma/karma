...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/graveman/graveman-0.3.12.ebuild,v 1.2 2005/05/17 19:39:27 dertobi123 Exp $

inherit gnome2

DESCRIPTION="Graphical frontend for cdrecord, mkisofs, readcd and sox using GTK+2"
HOMEPAGE="http://graveman.tuxfamily.org/"
SRC_URI="http://graveman.tuxfamily.org/sources/${PN}-${PV}.tar.gz"
