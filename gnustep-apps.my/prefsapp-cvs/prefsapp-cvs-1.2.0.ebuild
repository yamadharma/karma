...
S=${WORKDIR}/System/Frameworks/PrefsModule
...
mydoc="../../Applications/Preferences/README ../../Applications/Preferences/TODO"

S_ADD="../../Applications/Preferences"
...
src_install ()
{
    ...
    rm -rf ${D}${GNUSTEP_ROOT}/Network
    rm -rf ${D}${GNUSTEP_ROOT}/Local
}
