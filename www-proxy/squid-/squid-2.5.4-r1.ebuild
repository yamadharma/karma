...
# $Header: /home/cvsroot/gentoo-x86/net-www/squid/squid-2.5.4.ebuild,v 1.1 2003/09/19 02:12:19 woodchip Exp $

IUSE="pam ldap ssl sasl snmp debug wccp"

inherit eutils patch
...
src_compile () 
{
	...
	local myconf=""
	myconf="${myconf} `use_enable wccp wccpv2`"
