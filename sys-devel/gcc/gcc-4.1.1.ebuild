...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gcc/gcc-4.1.1.ebuild,v 1.21 2006/09/19 02:39:11 weeve Exp $
...
KEYWORDS="-* amd64 hppa mips ppc ~ppc64 ~s390 ~sparc x86 ~x86-fbsd"
...
src_unpack() {
	...
	# Fortran intrinsics
	epatch "${FILESDIR}"/4.1.1/gcc-4.1.1-fortran_intrinsics.patch

#	cd ${S}
#	aclocal -I ./config --acdir=libgfortran
