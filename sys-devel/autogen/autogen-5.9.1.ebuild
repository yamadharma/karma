...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/autogen/autogen-5.9.ebuild,v 1.4 2007/05/30 13:21:34 gustavoz Exp $
...
#	unpack ${A}
#	cd "${S}"
#	epatch "${FILESDIR}"/${PN}-5.8.8-scrub-debug.patch #172533
#}
