...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/alsa-plugins/alsa-plugins-1.0.14_rc3.ebuild,v 1.2 2007/04/19 14:11:40 gustavoz Exp $
...
src_unpack() {
	...
	# Stupid alsa upstream forgot this from the release.
	# Remove in next release
	cp -i "${FILESDIR}/${PV}-gcd.h" rate-lavc/gcd.h || die
