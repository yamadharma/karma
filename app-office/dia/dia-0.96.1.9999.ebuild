...
inherit eutils gnome2 libtool autotools versionator python subversion

# FIXME
# find-and-replace don't compile
ESVN_OPTIONS="-r{20081016}"
...
#	epatch ${FILESDIR}/find-end-replace.patch
