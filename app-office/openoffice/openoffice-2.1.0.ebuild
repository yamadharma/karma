...
kde ldap mono nas sound odbc odk pam seamonkey webdav xulrunner"
...
RESTRICT="binchecks"
use debug && RESTRICT="${RESTRICT} splitdebug"

# ftp://ftp.gwdg.de/pub/openoffice/stable/2.1.0/OOo_2.1.0_src_binfilter.tar.bz2
SRC_URI="mirror://openoffice/stable/${PV}/OOo_${PV}_src_core.tar.bz2
	mirror://openoffice/stable/${PV}/OOo_${PV}_src_l10n.tar.bz2
	binfilter? ( mirror://openoffice/stable/${PV}/OOo_${PV}_src_binfilter.tar.bz2 )
	odk? ( mirror://openoffice/stable/${PV}/OOo_${PV}_src_sdk.tar.bz2
