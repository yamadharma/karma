...
#	>=kde-base/kdepim-kresources-${PV}:${SLOT} missing ${PREFIX}"/include/kaddressbook/kabprefs_base.h
#	>=kde-base/kdepim-wizards-${PV}:${SLOT} because kdepim-kresources ^
#	>=kde-base/ktimetracker-${PV}:${SLOT} because kdepim-kresources ^^
