...
MY_64B_URI="http://download.macromedia.com/pub/labs/flashplayer10/flashplayer_square_p1_64bit_linux_${rdate}.tar.gz"
...
pkg_postinst() {
	...
	ewarn "Please consider only running flash applets ewarn you know to be safe."
	ewarn  "The 'flashblock' extension may help for mozilla users: "
