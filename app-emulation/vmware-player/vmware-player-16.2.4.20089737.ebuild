...
VMWARE_FUSION_VER="12.2.4/20089737"
...
SRC_URI="https://download3.vmware.com/software/WKST-PLAYER-${MY_PV//./}/${MY_P}.x86_64.bundle
...
src_install() {
	...
	echo 'SEARCH_DIRS_MASK="/opt/vmware"' > "${T}"/10vmware-player
	doins "${T}"/10vmware-player
...
#	fi
	...
	local tool
	for tool in thnuclnt vmplayer{,-daemon} licenseTool vmamqpd \
	...
	fperms 0755 /opt/vmware/lib/vmware/bin/{tpm2emu,vmrest}
