...
#	export MOC="$(qt6_get_bindir)/moc" \
#		UIC="$(qt6_get_bindir)/uic" \
#		RCC="$(qt6_get_bindir)/rcc" \
#		LRELEASE="$(qt6_get_bindir)/lrelease" \
#		QCOLLECTIONGENERATOR="$(qt6_get_bindir)/qcollectiongenerator" \
#		QHELPGENERATOR="$(qt6_get_bindir)/qhelpgenerator"
