...
SRC_URI="
	https://github.com/rstudio/rstudio/archive/v${PV%.*}+${PV##*.}.tar.gz -> ${P}.tar.gz
...
PATCHES=(
	"${FILESDIR}/${PN}-2022.02.0.443-ant-system-node.patch"
...
src_install() {
	...
	mv "${D}/${EPREFIX}/usr/bin/diagnostics" "${D}/${EPREFIX}/usr/bin/rstudio-diagnostics"
}
