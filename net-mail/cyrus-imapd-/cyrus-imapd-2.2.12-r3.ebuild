...
SRC_URI="ftp://ftp.andrew.cmu.edu/pub/cyrus-mail/${P}.tar.gz
	http://email.uoa.gr/download/cyrus/${P}/${P}-autocreate-0.9.4.diff
	http://email.uoa.gr/download/cyrus/${P}/${P}-autoreply-0.1-0.diff
	http://email.uoa.gr/download/cyrus/${P}/${P}-autosievefolder-0.6.diff
	http://email.uoa.gr/download/cyrus/${P}/${P}-rmquota+deletemailbox-0.2-1.diff"
...
src_unpack() {
	...
	epatch "${DISTDIR}/${P}-autocreate-0.9.4.diff"
	epatch "${DISTDIR}/${P}-autoreply-0.1-0.diff" 
	epatch "${DISTDIR}/${P}-autosievefolder-0.6.diff" 
	epatch "${DISTDIR}/${P}-rmquota+deletemailbox-0.2-1.diff" 
