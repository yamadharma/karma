...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/totem-pl-parser/totem-pl-parser-2.32.6.ebuild,v 1.1 2011/09/22 16:29:41 pacho Exp $
...
src_prepare() {
	...
	epatch ${FILESDIR}/totem-pl-parser-2.32.6-quvi-0.4.patch
}
