...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/boost/boost-1.36.0.ebuild,v 1.1 2008/12/16 16:37:27 dev-zero Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PF}-restore-deprecated-basic_directory_entry_names.patch"
