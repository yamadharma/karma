...
EGIT_BRANCH=non-mac80211

inherit linux-mod git


#ESVN_REPO_URI="https://acx100.svn.sourceforge.net/svnroot/acx100/trunk@{${PV##*_p}}"
S=${WORKDIR}/${PN}-${PV##*_p}

EGIT_REPO_URI=git://gitorious.org/acx-mac80211/mainline.git
