...
src_install () 
{
	...
	mv ${D}/usr/lib/libportaudio.so.0.0.19 ${D}/usr/lib/libportaudio-19.so.0.0.19
	mv ${D}/usr/lib/libportaudio.a ${D}/usr/lib/libportaudio-19.a
	
	dosym /usr/lib/libportaudio-19.so.0.0.19 /usr/lib/libportaudio-19.so.0
	dosym /usr/lib/libportaudio-19.so.0.0.19 /usr/lib/libportaudio-19.so
