...
#SRC_URI="http://bazaar.launchpad.net/~bzr/bzr-fastimport/trunk/tarball/359.1.1 -> ${PN}-${PV}.359.1.1.tgz"
...
RDEPEND=">=dev-vcs/bzr-1.18
	>=dev-python/python-fastimport-0.9.6"
DEPEND=""

DOCS=( NEWS README.txt doc/notes.txt )

#S=${WORKDIR}/~bzr/bzr-fastimport/trunk

PATCHES=(
	"${FILESDIR}/disable-known-graph-feature.patch"
	"${FILESDIR}/dont-use-get_ancestry.patch"
	"${FILESDIR}/import-binary-stream.patch"
	"${FILESDIR}/improve_error_message.patch"
)

#PATCHES=(
#	"${FILESDIR}/concatenate_str.patch"
#)
