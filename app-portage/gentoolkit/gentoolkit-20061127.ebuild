...
DESCRIPTION="Collection of administration scripts for Gentoo (Paludis)"
HOMEPAGE="http://www.gentoo.org/proj/en/portage/tools/index.xml"
SRC_URI="http://jordan83.250free.com/${P}.tar.gz"
...
pkg_postinst() {
	...
	echo
	ewarn "revdep-rebuild included in this package has been modified to use"
	ewarn "Paludis instead of Portage."
	echo
}
