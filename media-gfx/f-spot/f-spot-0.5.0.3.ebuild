...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/f-spot/f-spot-0.5.0.ebuild,v 1.1 2008/05/16 07:27:06 calchan Exp $

inherit gnome2 mono autotools eutils
...
RDEPEND=">=dev-lang/mono-1.1.10
	...
	>=dev-libs/glib-2
	>=x11-libs/gtk+-2.6
	>=dev-dotnet/gtk-sharp-2.12.1
	>=dev-dotnet/dbus-sharp-0.4.2
	>=dev-dotnet/dbus-glib-sharp-0.3.0
	>=dev-dotnet/gtkhtml-sharp-2.12.1
	>=dev-dotnet/gconf-sharp-2.12.1
	>=dev-dotnet/glade-sharp-2.12.1
	>=dev-dotnet/gnomevfs-sharp-2.12.1
