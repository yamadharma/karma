...
#	SRC_URI="https://media.inkscape.org/dl/resources/file/${P}.tar.xz"
	SRC_URI="https://inkscape.org/gallery/item/51256/inkscape-1.4beta.tar.xz"
	S=${WORKDIR}/inkscape-1.4-beta_2024-04-22_62f545ba5e
#	KEYWORDS="~alpha amd64 ~arm ~arm64 ~hppa ~ia64 ~loong ppc ppc64 ~riscv ~sparc x86"
fi
...
#PATCHES=(
#	"${FILESDIR}"/inkscape-1.3.2-libxml2-2.12.patch
#	"${FILESDIR}"/inkscape-1.3.2-poppler-24.03.patch
#	"${FILESDIR}"/inkscape-1.3.2-poppler-24.05.patch # bug 931917
#	"${FILESDIR}"/inkscape-1.3.2-cxx20.patch # bug 931917
#	"${FILESDIR}"/inkscape-1.3.2-cxx20-2.patch # bug 933216
