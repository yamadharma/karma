...
# Minimal builds only the LGPL modules.
# Supernodal adds the Supernodal module which is GPL and uses lapack/blas
# Metis adds the Partion module and uses metis/camd/ccolamd
# No use flags will build the all the modules that don't rely on extra
# libraries.
