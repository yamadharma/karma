...
# $Header: /home/cvsroot/gentoo-x86/sys-fs/udev/udev-021.ebuild,v 1.1 2004/03/04 19:13:03 azarah Exp $
...
#	myconf="${myconf} KERNEL_DIR=${ROOT}/usr/src/linux"
...
src_install() {
	...
	if use evms2
	then
		dosbin extras/multipath-tools/{multipath,devmap_name}
		exeinto /etc/hotplug.d/scsi/
		doexe extras/multipath-tools/multipath.hotplug
	fi
