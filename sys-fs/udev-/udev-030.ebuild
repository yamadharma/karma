...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/udev-030.ebuild,v 1.5 2004/08/14 04:08:56 vapier Exp $
...
#	doins etc/udev/udev.permissions
	...
	if [ -f ${ROOT}/usr/sbin/alsactl ]
	    then
	    exeinto /etc/dev.d/snd/controlC0
	    doexe etc/dev.d/snd/controlC0/alsa.dev
	fi	    
