...
# $Header: /home/cvsroot/gentoo-x86/net-dns/bind/bind-9.2.3.ebuild,v 1.9 2003/11/30 22:22:14 pebenito Exp $
...
src_install () 
{
	...
	dodir /etc/named /var/lib/named
	keepdir /var/lib/named /var/lib/named/master /var/lib/named/slave
...
pkg_postinst () 
{
	...
	einfo "/var/lib/named/pri/127 or /var/lib/named/pri/localhost"
	einfo
...
pkg_config () 
{
	...
	if [ ! "$EXISTS" = yes ]; then
		...
		cp -R /etc/named ${CHROOT}/etc/
		cp /etc/localtime ${CHROOT}/etc/localtime
		chown named:named ${CHROOT}/etc/named/rndc.key
		cp -R /var/lib/named ${CHROOT}/var/
		...
		einfo "   alias rndc='rndc -k ${CHROOT}/etc/named/rndc.key'"
